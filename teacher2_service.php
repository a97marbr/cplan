<?php 
    ...
    $stmt->execute();
    $tblhead=array("ccode"=>"Course Code","cname"=>"Course Name","time_allocation"=>"Time Allocated","start_period"=>"Start","end_period"=>"End");
    $tblfoot=array();
    $tblbody=array();
    $columnOrder=array("ccode","cname","start_period","end_period","time_allocation");
